...
// AdRepository is an autogenerated mocks type for the AdRepository type
type AdRepository struct {
	mock.Mock
}

// CreateAd provides a mocks function with given fields: ad
func (_m *AdRepository) CreateAd(ad *domain.Ad) (string, error) {
	ret := _m.Called(ad)
...
func (_m *AdRepository) GetAd(adId string, optionalFields []string) (domain.Ad, error) {
...
func (_m *AdRepository) GetAdList(page int, sortField service.SortField, sortOrder service.SortOrder) ([]domain.Ad, error) {
